...
| 32 | [最长有效括号](https://leetcode.cn/problems/longest-valid-parentheses/) | 🔴 困难 | 栈、字符串、动态规划 | 2025.12.10 |
| 33 | [搜索旋转排序数组](https://leetcode.cn/problems/search-in-rotated-sorted-array/) | 🟡 中等 | 数组、二分查找 | 2025.12.05 |
...
| 41 | [缺失的第一个正数](https://leetcode.cn/problems/first-missing-positive/) | 🔴 困难 | 数组、哈希表 | 2026.02.02 |
...
| 50 | [Pow(x, n)](https://leetcode.cn/problems/powx-n/) | 🟡 中等 | 递归、数学 | **2次**<br>2025.12.15<br>2026.02.18 |
| 51 | [N 皇后](https://leetcode.cn/problems/n-queens/) | 🔴 困难 | 数组、回溯 | 2026.01.09 |
| 52 | [N 皇后 II](https://leetcode.cn/problems/n-queens-ii/) | 🔴 困难 | 回溯 | 2026.01.09 |
...
| 56 | [合并区间](https://leetcode.cn/problems/merge-intervals/) | 🟡 中等 | 数组、排序 | 2026.02.06 |
...
| 64 | [最小路径和](https://leetcode.cn/problems/minimum-path-sum/) | 🟡 中等 | 数组、动态规划、矩阵 | 2025.12.28 |
| 66 | [加一](https://leetcode.cn/problems/plus-one/) | 🟢 简单 | 数组、数学 | 2025.10.28 |
| 67 | [二进制求和](https://leetcode.cn/problems/add-binary/) | 🟢 简单 | 位运算、数学、字符串、模拟 | 2026.02.15 |
...
| 79 | [单词搜索](https://leetcode.cn/problems/word-search/) | 🟡 中等 | 深度优先搜索、数组、字符串、回溯、矩阵 | 2026.01.16 |
...
| 101 | [对称二叉树](https://leetcode.cn/problems/symmetric-tree/) | 🟢 简单 | 树、深度优先搜索、广度优先搜索、二叉树 | 2025.11.20 |
...
| 105 | [从前序与中序遍历序列构造二叉树](https://leetcode.cn/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) | 🟡 中等 | 树、数组、哈希表、分治、二叉树 | 2026.01.08 |
...
| 108 | [将有序数组转换为二叉搜索树](https://leetcode.cn/problems/convert-sorted-array-to-binary-search-tree/) | 🟢 简单 | 树、二叉搜索树、数组、分治、二叉树 | 2026.01.08 |
...
| 130 | [被围绕的区域](https://leetcode.cn/problems/surrounded-regions/) | 🟡 中等 | 深度优先搜索、广度优先搜索、并查集、数组、矩阵 | 2026.01.14 |
| 131 | [分割回文串](https://leetcode.cn/problems/palindrome-partitioning/) | 🟡 中等 | 字符串、动态规划、回溯 | 2026.01.07 |
| 133 | [克隆图](https://leetcode.cn/problems/clone-graph/) | 🟡 中等 | 深度优先搜索、广度优先搜索、图、哈希表 | 2026.01.13 |
...
| 160 | [相交链表](https://leetcode.cn/problems/intersection-of-two-linked-lists/) | 🟢 简单 | 哈希表、链表、双指针 | 2025.11.11 |
| 165 | [比较版本号](https://leetcode.cn/problems/compare-version-numbers/) | 🟡 中等 | 双指针、字符串 | 2025.12.08 |
| 167 | [两数之和 II - 输入有序数组](https://leetcode.cn/problems/two-sum-ii-input-array-is-sorted/) | 🟡 中等 | 数组、双指针、二分查找 | 2025.12.08 |
| 169 | [多数元素](https://leetcode.cn/problems/majority-element/) | 🟢 简单 | 数组、哈希表、分治、计数、排序 | 2025.10.27 |
...
| 190 | [颠倒二进制位](https://leetcode.cn/problems/reverse-bits/) | 🟢 简单 | 位运算、分治 | 2026.02.16 |
| 198 | [打家劫舍](https://leetcode.cn/problems/house-robber/) | 🟡 中等 | 数组、动态规划 | 2026.03.24 |
...
| 222 | [完全二叉树的节点个数](https://leetcode.cn/problems/count-complete-tree-nodes/) | 🟢 简单 | 位运算、树、二分查找、二叉树 | 2025.11.21 |
| 223 | [矩形面积](https://leetcode.cn/problems/rectangle-area/) | 🟡 中等 | 几何、数学 | 2025.12.06 |
| 224 | [基本计算器](https://leetcode.cn/problems/basic-calculator/) | 🔴 困难 | 栈、递归、数学、字符串 | 2025.12.10 |
| 226 | [翻转二叉树](https://leetcode.cn/problems/invert-binary-tree/) | 🟢 简单 | 树、深度优先搜索、广度优先搜索、二叉树 | 2025.11.20 |
| 227 | [基本计算器 II](https://leetcode.cn/problems/basic-calculator-ii/) | 🟡 中等 | 栈、数学、字符串 | 2025.12.07 |
| 229 | [多数元素 II](https://leetcode.cn/problems/majority-element-ii/) | 🟡 中等 | 数组、哈希表、计数、排序 | 2025.12.10 |
...
| 344 | [反转字符串](https://leetcode.cn/problems/reverse-string/) | 🟢 简单 | 双指针、字符串 | 2025.11.05 |
| 345 | [反转字符串中的元音字母](https://leetcode.cn/problems/reverse-vowels-of-a-string/) | 🟢 简单 | 双指针、字符串 | 2025.11.05 |
...
| 373 | [查找和最小的 K 对数字](https://leetcode.cn/problems/find-k-pairs-with-smallest-sums/) | 🟡 中等 | 数组、堆（优先队列） | 2026.02.08 |
| 374 | [猜数字大小](https://leetcode.cn/problems/guess-number-higher-or-lower/) | 🟢 简单 | 二分查找、交互 | 2025.11.10 |
| 377 | [组合总和 Ⅳ](https://leetcode.cn/problems/combination-sum-iv/) | 🟡 中等 | 数组、动态规划 | 2026.06.02 |
...
| 392 | [判断子序列](https://leetcode.cn/problems/is-subsequence/) | 🟢 简单 | 双指针、字符串、动态规划 | 2025.11.05 |
| 394 | [字符串解码](https://leetcode.cn/problems/decode-string/) | 🟡 中等 | 栈、递归、字符串 | 2025.12.26 |
| 396 | [旋转函数](https://leetcode.cn/problems/rotate-function/) | 🟡 中等 | 数组、数学、动态规划 | 2026.02.05 |
| 401 | [二进制手表](https://leetcode.cn/problems/binary-watch/) | 🟢 简单 | 位运算、回溯 | 2026.02.17 |
...
| 416 | [分割等和子集](https://leetcode.cn/problems/partition-equal-subset-sum/) | 🟡 中等 | 数组、动态规划 | 2026.04.11 |
...
| 1415 | [长度为 n 的开心字符串中字典序第 k 小的字符串](https://leetcode.cn/problems/the-k-th-lexicographical-string-of-all-happy-strings-of-length-n/) | 🟡 中等 | 字符串、回溯 | 2026.03.14 |
...
| 1594 | [矩阵的最大非负积](https://leetcode.cn/problems/maximum-non-negative-product-in-a-matrix/) | 🟡 中等 | 数组、动态规划、矩阵 | 2026.03.23 |
...
| 2058 | [找出临界点之间的最小和最大距离](https://leetcode.cn/problems/find-the-minimum-and-maximum-number-of-nodes-between-critical-points/) | 🟡 中等 | 链表 | 2026.08.31 |
...
| 3823 | [反转一个字符串里的字母后反转特殊字符](https://leetcode.cn/problems/reverse-letters-then-special-characters-in-a-string/) | 🟢 简单 | 双指针、字符串、模拟 | 2026.01.31 |
| 3824 | [减小数组使其满足条件的最小 K 值](https://leetcode.cn/problems/minimum-k-to-reduce-array-within-limit/) | 🟡 中等 | 数组、二分查找 | 2026.01.31 |
...
| 3904 | [最小稳定下标 II](https://leetcode.cn/problems/smallest-stable-index-ii/) | 🟡 中等 | 数组、前缀和 | 2026.09.04 |
